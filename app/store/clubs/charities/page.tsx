...
export const metadata: Metadata = { title: 'Charities', description: 'Custom sportswear and merchandise for charities and community organisations.' };

export default async function CharitiesPage() {
  const teams = await getClubsBySportAsync('charities');
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <nav className="text-sm text-muted mb-6">
        ...
        <span className="text-foreground font-medium">Charities</span>
      </nav>
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-emerald-600 to-teal-800 p-8 sm:p-12 mb-10">
        <h1 className="font-[var(--font-heading)] text-4xl md:text-6xl font-bold text-white uppercase relative z-10">Charities</h1>
        <p className="text-white/80 mt-3 relative z-10">Custom merchandise and sportswear for charitable organisations. Making a difference together.</p>
