...
export const metadata: Metadata = { title: 'Rugby Clubs', description: 'Shop official kit for all our partner rugby clubs.' };

export default async function RugbyClubsPage() {
  const rugbyClubs = await getClubsBySportAsync('rugby');
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <nav className="text-sm text-muted mb-6">
        ...
        <span className="text-foreground font-medium">Rugby Clubs</span>
      </nav>
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-primary to-primary-light p-8 sm:p-12 mb-10">
        <h1 className="font-[var(--font-heading)] text-4xl md:text-6xl font-bold text-white uppercase relative z-10">Rugby Clubs</h1>
        <p className="text-white/80 mt-3 relative z-10">Official kit suppliers for rugby clubs across the UK.</p>
