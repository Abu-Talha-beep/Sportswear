...
export const metadata: Metadata = { title: 'Netball Clubs', description: 'Official netball kit and team wear.' };

export default async function NetballPage() {
  const teams = await getClubsBySportAsync('netball');
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <nav className="text-sm text-muted mb-6">
        ...
        <span className="text-foreground font-medium">Netball</span>
      </nav>
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-blue-600 to-primary p-8 sm:p-12 mb-10">
        <h1 className="font-[var(--font-heading)] text-4xl md:text-6xl font-bold text-white uppercase relative z-10">Netball</h1>
        <p className="text-white/80 mt-3 relative z-10">High-performance netball dresses, training wear and accessories.</p>
