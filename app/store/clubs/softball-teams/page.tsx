...
export const metadata: Metadata = { title: 'Softball Teams', description: 'Shop official kit for our partner softball teams.' };

export default async function SoftballTeamsPage() {
  const teams = await getClubsBySportAsync('softball');
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <nav className="text-sm text-muted mb-6">
        ...
        <span className="text-foreground font-medium">Softball Teams</span>
      </nav>
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-emerald-700 to-primary p-8 sm:p-12 mb-10">
        <h1 className="font-[var(--font-heading)] text-4xl md:text-6xl font-bold text-white uppercase relative z-10">Softball Teams</h1>
        <p className="text-white/80 mt-3 relative z-10">Official kit for the UK softball community.</p>
