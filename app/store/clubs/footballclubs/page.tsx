...
export const metadata: Metadata = { title: 'Football Clubs', description: 'Shop official kit for all our partner football clubs.' };

export default async function FootballClubsPage() {
  const footballClubs = await getClubsBySportAsync('football');
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <nav className="text-sm text-muted mb-6">
        ...
        <span className="text-foreground font-medium">Football Clubs</span>
      </nav>
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-accent to-primary p-8 sm:p-12 mb-10">
        <h1 className="font-[var(--font-heading)] text-4xl md:text-6xl font-bold text-white uppercase relative z-10">Football Clubs</h1>
        <p className="text-white/80 mt-3 relative z-10">Official kit suppliers for football clubs across the UK.</p>
