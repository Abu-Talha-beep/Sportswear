...
export const metadata: Metadata = { title: 'Horseball', description: 'Kit for the UK horseball community.' };

export default async function HorseballPage() {
  const teams = await getClubsBySportAsync('horseball');
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <nav className="text-sm text-muted mb-6">
        ...
        <span className="text-foreground font-medium">Horseball</span>
      </nav>
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-amber-800 to-primary p-8 sm:p-12 mb-10">
        <h1 className="font-[var(--font-heading)] text-4xl md:text-6xl font-bold text-white uppercase relative z-10">Horseball</h1>
        <p className="text-white/80 mt-3 relative z-10">Equestrian sport excellence — custom kit for horseball teams.</p>
