...
const categories = [
  ...
  { label: 'Leisurewear', slug: 'leisurewear' },
  { label: 'Fashionwear', slug: 'fashionwear' },
  { label: 'Player Equipment', slug: 'playerequipment' },
  { label: 'Rugby Gear', slug: 'rugbygear' },
...
export default async function StorePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="font-[var(--font-heading)] text-4xl md:text-5xl font-bold text-primary uppercase">
          Shop All
        </h1>
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {categories.map((cat) => (
          <Link
            key={cat.slug}
            href={cat.slug === 'all' ? '/store' : `/store/shop/${cat.slug}`}
